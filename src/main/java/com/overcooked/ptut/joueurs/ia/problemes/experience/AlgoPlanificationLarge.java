...
public class AlgoPlanificationLarge extends SearchProblemAC {
    ...
    public AlgoPlanificationLarge(Plat plat, int numJoueur, DonneesJeu donneesJeu) {
    ...
    public ArrayList<AlimentCoordonnees> getAlimentCoordonnees(State s) {
        ...
        AlgoPlanificationLargeEtat o = (AlgoPlanificationLargeEtat) s;
...
//                    }
    ...
    public State doAlimentCoordonnees(State s, AlimentCoordonnees a) {
        AlgoPlanificationLargeEtat o = (AlgoPlanificationLargeEtat) s.clone();
    ...
    public boolean isGoalState(State s) {
        return ((AlgoPlanificationLargeEtat) s).estAuDepot();
    }
    ...
    public double getAlimentCost(State s, AlimentCoordonnees a) {
        if (((AlgoPlanificationLargeEtat) s).estDepose()) return 0;

        int[] coordonneesActuelle = ((AlgoPlanificationLargeEtat) s).getCoordonneesActuelles();
