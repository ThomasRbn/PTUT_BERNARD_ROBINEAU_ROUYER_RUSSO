 ...
 *
 */
public abstract class TreeSearchAC {

    /**
     * Le problème à résoudre
     */

    protected SearchProblemAC problem;
     ...
     */
    protected SearchNodeAC end_node;

    /*
     * La liste des nœuds a étendre
     */
    protected Queue<SearchNodeAC> frontier = null;
     ...
     */
    public TreeSearchAC(SearchProblemAC p, State s){
        intial_state = s;
        problem = p;
    }
...
//    public abstract ArrayList<Action> solve();
    ...
    public void printSolution() {
        ...
        ArrayList<AlimentCoordonnees> solution = end_node.getPathFromRoot();
       
        // Afficher des trucs 
        System.out.print("Solution: \n"+ intial_state+ " > ");
        Misc.printCollection(solution, '>');
        System.out.println("Solved ! Explored "+
                           SearchNodeAC.getTotalSearchNodes() +
                           " nodes. Max depth was "+
                           SearchNodeAC.getMaxDepth() +
